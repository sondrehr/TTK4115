...
typedef struct {
  ...
  real_T Integrator2[5];               /* '<S5>/Integrator2' */
  ...
  real_T ManualSwitch[5];              /* '<Root>/Manual Switch' */
  ...
  real_T Sum5[5];                      /* '<S5>/Sum5' */
  real_T Sum3;                         /* '<Root>/Sum3' */
  real_T Sum4;                         /* '<Root>/Sum4' */
  real_T euler_rates[3];               /* '<S6>/Gyro vector to [pitch rate, elevation rate, travle rate]' */
  real_T x_future[6];                  /* '<S4>/LabDag4_3Predition' */
  real_T P_future[36];                 /* '<S4>/LabDag4_3Predition' */
  real_T x_now[6];                     /* '<S4>/LabDag4_3Correction' */
  real_T P_now[36];                    /* '<S4>/LabDag4_3Correction' */
  uint8_T StreamCall1_o2;              /* '<S11>/Stream Call1' */
} B_heli_q8_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T UnitDelay_DSTATE[6];          /* '<S4>/Unit Delay' */
  real_T UnitDelay1_DSTATE[36];        /* '<S4>/Unit Delay1' */
  ...
  real_T Memory_PreviousInput[10];     /* '<S11>/Memory' */
  ...
  t_stream StreamCall1_Stream;         /* '<S11>/Stream Call1' */
  ...
  struct {
    void *FilePtr;
  } ToFile2_PWORK_k;                   /* '<S5>/To File2' */

  struct {
    void *FilePtr;
  } ToFile4_PWORK;                     /* '<S6>/To File4' */

  struct {
    void *FilePtr;
  } ToFile5_PWORK;                     /* '<S6>/To File5' */

  struct {
    void *FilePtr;
  } ToFile6_PWORK;                     /* '<S6>/To File6' */

  struct {
    void *FilePtr;
  } ToFile7_PWORK;                     /* '<S6>/To File7' */

  struct {
    void *LoggedData;
  } Connected_PWORK;                   /* '<S11>/Connected' */
  ...
  int32_T clockTickCounter;            /* '<Root>/e_c_dot' */
  ...
  struct {
    int_T Count;
    int_T Decimation;
  } ToFile2_IWORK_m;                   /* '<S5>/To File2' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile4_IWORK;                     /* '<S6>/To File4' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile5_IWORK;                     /* '<S6>/To File5' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile6_IWORK;                     /* '<S6>/To File6' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile7_IWORK;                     /* '<S6>/To File7' */

  uint8_T StreamCall1_State;           /* '<S11>/Stream Call1' */
} DW_heli_q8_T;

/* Continuous states (auto storage) */
typedef struct {
  real_T Integrator2_CSTATE[5];        /* '<S5>/Integrator2' */
...
/* State disabled  */
typedef struct {
  boolean_T Integrator2_CSTATE[5];     /* '<S5>/Integrator2' */
...
struct P_heli_q8_T_ {
  real_T A_2[25];                      /* Variable: A_2
                                        * Referenced by: '<S5>/Gain6'
                                        */
  real_T B_2[10];                      /* Variable: B_2
  ...
  real_T Constant2_Value_f;            /* Expression: 0
                                        ...
                                        */
  real_T e_c_dot_Amp;                  /* Expression: 10
                                        * Referenced by: '<Root>/e_c_dot'
                                        */
  real_T e_c_dot_Period;               /* Computed Parameter: e_c_dot_Period
                                        * Referenced by: '<Root>/e_c_dot'
                                        */
  real_T e_c_dot_Duty;                 /* Computed Parameter: e_c_dot_Duty
                                        * Referenced by: '<Root>/e_c_dot'
                                        */
  real_T e_c_dot_PhaseDelay;           /* Expression: 10
                                        * Referenced by: '<Root>/e_c_dot'
                                        */
  ...
  real_T UnitDelay_InitialCondition[6];/* Expression: zeros(6,1)
                                        ...
                                        */
  real_T UnitDelay1_InitialCondition[36];/* Expression: eye(6)
  ...
  real_T ElevationCounttorad_Gain;     /* Expression: -2 * pi /4096
                                        ...
                                        */
  real_T Constant1_Value_l;            /* Expression: 0.4
  ...
  real_T TravelTransferFcn_D;          /* Computed Parameter: TravelTransferFcn_D
                                        * Referenced by: '<S2>/Travel: Transfer Fcn'
                                        */
  real_T Step_Time;                    /* Expression: 12
  ...
  real_T Step_YFinal;                  /* Expression: 1
                                        * Referenced by: '<S7>/Step'
                                        */
  real_T Step1_Time;                   /* Expression: 18
  ...
  real_T Step2_YFinal;                 /* Expression: 1
                                        * Referenced by: '<S7>/Step2'
                                        */
  real_T Step3_Time;                   /* Expression: 24
  ...
  real_T Step3_YFinal;                 /* Expression: 1
                                        * Referenced by: '<S7>/Step3'
                                        */
  real_T Step4_Time;                   /* Expression: 28
  ...
  real_T Step4_YFinal;                 /* Expression: 1
                                        * Referenced by: '<S7>/Step4'
                                        */
  real_T Step5_Time;                   /* Expression: 32
                                        * Referenced by: '<S7>/Step5'
                                        */
  real_T Step5_Y0;                     /* Expression: 0
                                        * Referenced by: '<S7>/Step5'
                                        */
  real_T Step5_YFinal;                 /* Expression: 2
                                        * Referenced by: '<S7>/Step5'
                                        */
  real_T Step6_Time;                   /* Expression: 34
                                        * Referenced by: '<S7>/Step6'
                                        */
  real_T Step6_Y0;                     /* Expression: 0
                                        * Referenced by: '<S7>/Step6'
                                        */
  real_T Step6_YFinal;                 /* Expression: 2
                                        * Referenced by: '<S7>/Step6'
                                        */
  real_T Step7_Time;                   /* Expression: 38
                                        * Referenced by: '<S7>/Step7'
                                        */
  ...
  uint32_T StreamFormattedWrite_MaxUnits;/* Computed Parameter: StreamFormattedWrite_MaxUnits
                                          * Referenced by: '<S11>/Stream Formatted Write'
                                          */
 ...
 * '<S2>'   : 'heli_q8/Heli 3D'
 * '<S3>'   : 'heli_q8/Joystick'
 * '<S4>'   : 'heli_q8/Kalman filter'
 * '<S5>'   : 'heli_q8/Luenberger Observer'
 * '<S6>'   : 'heli_q8/Math logic'
 * '<S7>'   : 'heli_q8/pitch'
 * '<S8>'   : 'heli_q8/Kalman filter/LabDag4_3Correction'
 * '<S9>'   : 'heli_q8/Kalman filter/LabDag4_3Predition'
 * '<S10>'  : 'heli_q8/Math logic/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S11>'  : 'heli_q8/Math logic/IMU'
 * '<S12>'  : 'heli_q8/Math logic/accel->angles'
 */
