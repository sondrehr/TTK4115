...
/* Block signals for system '<S4>/Gyro vector to [pitch rate, elevation rate, travle rate]' */
typedef struct {
  real_T euler_rates[3];               /* '<S4>/Gyro vector to [pitch rate, elevation rate, travle rate]' */
} B_Gyrovectortopitchrateelevat_T;

/* Block signals (auto storage) */
typedef struct {
  real_T Integrator2[5];               /* '<S3>/Integrator2' */
  ...
  real_T ManualSwitch2[5];             /* '<Root>/Manual Switch2' */
  ...
  uint8_T StreamCall1_o2;              /* '<S8>/Stream Call1' */
  B_Gyrovectortopitchrateelevat_T sf_Gyrovectortopitchrateeleva_f;/* '<S4>/Gyro vector to [pitch rate, elevation rate, travle rate]1' */
  B_Gyrovectortopitchrateelevat_T sf_Gyrovectortopitchrateelevati;/* '<S4>/Gyro vector to [pitch rate, elevation rate, travle rate]' */
} B_heli_q8_T;
...
typedef struct {
  ...
  real_T Memory_PreviousInput[10];     /* '<S8>/Memory' */
  ...
  struct {
    void *FilePtr;
  } ToFile6_PWORK;                     /* '<S4>/To File6' */

  struct {
    void *FilePtr;
  } ToFile7_PWORK;                     /* '<S4>/To File7' */

  struct {
    void *FilePtr;
  } ToFile8_PWORK;                     /* '<S4>/To File8' */

  struct {
    void *LoggedData;
  } Connected_PWORK;                   /* '<S8>/Connected' */
  ...
  int32_T clockTickCounter;            /* '<S5>/e_c_dot' */
  ...
  struct {
    int_T Count;
    int_T Decimation;
  } ToFile6_IWORK;                     /* '<S4>/To File6' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile7_IWORK;                     /* '<S4>/To File7' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile8_IWORK;                     /* '<S4>/To File8' */
...
typedef struct {
  real_T Integrator2_CSTATE[5];        /* '<S3>/Integrator2' */
...
/* State disabled  */
typedef struct {
  boolean_T Integrator2_CSTATE[5];     /* '<S3>/Integrator2' */
 ...
 * '<S2>'   : 'heli_q8/Heli 3D'
 * '<S3>'   : 'heli_q8/Luenberger observer'
 * '<S4>'   : 'heli_q8/Math logic'
 * '<S5>'   : 'heli_q8/Subsystem'
 * '<S6>'   : 'heli_q8/Math logic/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S7>'   : 'heli_q8/Math logic/Gyro vector to [pitch rate, elevation rate, travle rate]1'
 * '<S8>'   : 'heli_q8/Math logic/IMU'
 * '<S9>'   : 'heli_q8/Math logic/accel->angles'
 * '<S10>'  : 'heli_q8/Subsystem/Joystick'
 * '<S11>'  : 'heli_q8/Subsystem/pitch'
 */
