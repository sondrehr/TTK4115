...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&heli_q8_B.Integrator2[0]), 0, 0, 50 },

  { (char_T *)(&heli_q8_B.StreamCall1_o2), 3, 0, 1 },

  { (char_T *)(&heli_q8_B.sf_Gyrovectortopitchrateeleva_f.euler_rates[0]), 0, 0,
    3 },

  { (char_T *)(&heli_q8_B.sf_Gyrovectortopitchrateelevati.euler_rates[0]), 0, 0,
    3 }
  ,
  ...
  { (char_T *)(&heli_q8_DW.Scope_PWORK.LoggedData[0]), 11, 0, 30 },
...
static DataTypeTransition rtPTransitions[] = {
  ...
  { (char_T *)(&heli_q8_P.Constant3_Value), 0, 0, 119 },
  ...
  { (char_T *)(&heli_q8_P.ManualSwitch2_CurrentSetting), 3, 0, 262 },
