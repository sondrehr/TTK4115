...
typedef RT_MODEL_IMU_heli_3_10_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * IMU_heli_3_10(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(IMU_heli_3_10_M, GBLbuf.message);
}
  ...
  control_c_handler(int signal_number)
{
  ...
  {
    stream_shutdown(IMU_heli_3_10_DW.StreamCall1_Stream);
  }
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://IMU_heli_3_10:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: IMU_heli_3_10 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
