...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* DeadZone: '<S4>/Dead Zone: x' incorporates:
     *  Constant: '<Root>/Constant'
     *  S-Function (hil_initialize_block): '<Root>/HIL Initialize'
     *  S-Function (hil_read_encoder_timebase_block): '<S3>/HIL Read Encoder Timebase'
     */
  ...
  if (heli_q8_P.ManualSwitch_CurrentSetting == 1) {
    ...
    heli_q8_B.ManualSwitch = ((((0.0 - currentTime) - currentTime_0) + (u0 +
  ...
  heli_q8_B.TransferFcn1 = 0.0;
  heli_q8_B.TransferFcn1 += heli_q8_P.TransferFcn1_C *
    heli_q8_X.TransferFcn1_CSTATE;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S3>/Pitch: Count to rad' */
    heli_q8_B.PitchCounttorad = heli_q8_P.PitchCounttorad_Gain *
      rtb_HILReadEncoderTimebase_o2;

    /* DiscretePulseGenerator: '<S1>/e_c_dot' */
    ...
    /* End of DiscretePulseGenerator: '<S1>/e_c_dot' */
    ...
    /* SignalConversion: '<S1>/TmpSignal ConversionAtTo FileInport1' */
    rtb_TmpSignalConversionAtToFile[0] = heli_q8_B.ManualSwitch;
    rtb_TmpSignalConversionAtToFile[1] = heli_q8_B.PitchCounttorad;
    rtb_TmpSignalConversionAtToFile[2] = heli_q8_B.ManualSwitch1;
    rtb_TmpSignalConversionAtToFile[3] = heli_q8_B.TransferFcn1;

    /* ToFile: '<S1>/To File' */
    if (rtmIsMajorTimeStep(heli_q8_M)) {
      {
        if (!(++heli_q8_DW.ToFile_IWORK.Decimation % 1) &&
            (heli_q8_DW.ToFile_IWORK.Count*5)+1 < 100000000 ) {
          ...
          if (fp != (NULL)) {
            ...
            if (fwrite(u, sizeof(real_T), 5, fp) != 5) {
              rtmSetErrorStatus(heli_q8_M,
                                "Error writing to MAT-file Joystick.mat");
              return;
            }

            if (((++heli_q8_DW.ToFile_IWORK.Count)*5)+1 >= 100000000) {
              (void)fprintf(stdout,
  ...
  for (i = 0; i < 2; i++) {
     ...
     */
    tmp_0[i] = 0.0;
    tmp_0[i] += heli_q8_P.F[i] * heli_q8_B.ManualSwitch;
    tmp_0[i] += heli_q8_P.F[i + 2] * heli_q8_B.ManualSwitch1;
  ...
  rtb_e_c_dot = heli_q8_P.BackmotorSaturation_LowerSat;
  if (u0 > heli_q8_P.BackmotorSaturation_UpperSat) {
    heli_q8_B.BackmotorSaturation = heli_q8_P.BackmotorSaturation_UpperSat;
  } else if (u0 < rtb_e_c_dot) {
    heli_q8_B.BackmotorSaturation = rtb_e_c_dot;
  } else {
  ...
  /* Sum: '<Root>/Sum3' */
  heli_q8_B.Sum3 = heli_q8_B.PitchCounttorad - heli_q8_B.ManualSwitch;

  /* Sum: '<Root>/Sum4' */
  heli_q8_B.Sum4 = heli_q8_B.ElevationTransferFcn - heli_q8_B.ManualSwitch1;
}
...
void heli_q8_derivatives(void)
{
  ...
  _rtXdot->TransferFcn1_CSTATE += heli_q8_P.TransferFcn1_A *
    heli_q8_X.TransferFcn1_CSTATE;
  _rtXdot->TransferFcn1_CSTATE += heli_q8_B.ElevationTransferFcn;
...
void heli_q8_output2(void)             /* Sample time: [0.01s, 0.0s] */
{
  ...
  /* S-Function Block: heli_q8/Controllers/Joystick/Game Controller (game_controller_block) */
  {
...
void heli_q8_initialize(void)
{
  ...
  /* Start for DiscretePulseGenerator: '<S1>/e_c_dot' */
  ...
  /* Start for ToFile: '<S1>/To File' */
  {
    ...
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M, "Error creating .mat file Joystick.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,5,0,"Joystick")) {
      rtmSetErrorStatus(heli_q8_M,
  ...
  heli_q8_X.TransferFcn1_CSTATE = 0.0;
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<S1>/To File' */
  {
    ...
    if (fp != (NULL)) {
      char fileName[509] = "Joystick.mat";
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M, "Error closing MAT-file Joystick.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M, "Error reopening MAT-file Joystick.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 5, heli_q8_DW.ToFile_IWORK.Count,
           "Joystick")) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for Joystick to MAT-file Joystick.mat");
      }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3634256239U);
  heli_q8_M->Sizes.checksums[1] = (1983455647U);
  heli_q8_M->Sizes.checksums[2] = (1988003411U);
  heli_q8_M->Sizes.checksums[3] = (890215915U);
  ...
  heli_q8_M->Sizes.numBlocks = (68);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (20);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (186);/* Sum of parameter "widths" */
  return heli_q8_M;
}
