...
typedef struct {
  ...
  int32_T clockTickCounter;            /* '<S1>/e_c_dot' */
  uint32_T HILInitialize_POSortedChans[8];/* '<Root>/HIL Initialize' */
  struct {
    int_T Count;
    int_T Decimation;
  } ToFile_IWORK;                      /* '<S1>/To File' */
} DW_heli_q8_T;
 ...
 *
 * '<Root>' : 'heli_q8'
 * '<S1>'   : 'heli_q8/Controllers'
 * '<S2>'   : 'heli_q8/Conversion'
 * '<S3>'   : 'heli_q8/Heli 3D'
 * '<S4>'   : 'heli_q8/Controllers/Joystick'
 * '<S5>'   : 'heli_q8/Controllers/pitch'
 */
