 ...
 *
 * '<Root>' : 'heli_q8'
 * '<S1>'   : 'heli_q8/Controller'
 * '<S2>'   : 'heli_q8/Conversion'
 * '<S3>'   : 'heli_q8/Elevation controller'
 * '<S4>'   : 'heli_q8/Heli 3D'
 * '<S5>'   : 'heli_q8/Pitch controller'
 * '<S6>'   : 'heli_q8/Controller/Joystick'
 * '<S7>'   : 'heli_q8/Controller/Subsystem'
 * '<S8>'   : 'heli_q8/Elevation controller/Elevation controller'
 */
