...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  real_T rtb_TmpSignalConversionAtToFi_b[2];
  real_T rtb_Gain4;
  real_T rtb_Gain3;
  real_T rtb_Sum_k;
  real_T rtb_Backgain;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* S-Function Block: heli_q8/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_Gain4 = heli_q8_DW.HILReadEncoderTimebase_Buffer[0];
        rtb_Gain3 = heli_q8_DW.HILReadEncoderTimebase_Buffer[1];
        rtb_Sum_k = heli_q8_DW.HILReadEncoderTimebase_Buffer[2];
      }
    }

    /* Gain: '<S4>/Travel: Count to rad' */
    heli_q8_B.TravelCounttorad = heli_q8_P.TravelCounttorad_Gain * rtb_Gain4;

    /* Gain: '<S4>/Pitch: Count to rad' */
    heli_q8_B.PitchCounttorad = heli_q8_P.PitchCounttorad_Gain * rtb_Gain3;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    rtb_Sum_k = heli_q8_B.ElevationCounttorad - heli_q8_P.Constant1_Value;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    rtb_TmpSignalConversionAtToFile[4] = rtb_Sum_k;
    ...
    if (rtmIsMajorTimeStep(heli_q8_M)) {
      {
        if (!(++heli_q8_DW.ToFile1_IWORK.Decimation % 1) &&
            (heli_q8_DW.ToFile1_IWORK.Count*7)+1 < 100000000 ) {
          ...
          if (fp != (NULL)) {
            ...
            if (fwrite(u, sizeof(real_T), 7, fp) != 7) {
              rtmSetErrorStatus(heli_q8_M,
                                "Error writing to MAT-file enc_2i_3i.mat");
              return;
            }

            if (((++heli_q8_DW.ToFile1_IWORK.Count)*7)+1 >= 100000000) {
              (void)fprintf(stdout,
                            "*** The ToFile block will stop logging data before\n"
                            "    the simulation has ended, because it has reached\n"
                            "    the maximum number of elements (100000000)\n"
                            "    allowed in MAT-file enc_2i_3i.mat.\n");
            }
          }
        }
      }
    ...
    if (heli_q8_B.RateTransitionx > heli_q8_P.DeadZonex_End) {
      rtb_Gain3 = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_End;
    } else if (heli_q8_B.RateTransitionx >= heli_q8_P.DeadZonex_Start) {
      rtb_Gain3 = 0.0;
    } else {
      rtb_Gain3 = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S6>/Gain: x'
     */
    heli_q8_B.Joystick_gain_x = heli_q8_P.Gainx_Gain * rtb_Gain3 *
      heli_q8_P.Joystick_gain_x;

    /* Gain: '<S1>/Gain3' incorporates:
     *  Gain: '<S1>/Gain'
     */
    rtb_Gain3 = heli_q8_P.Gain_Gain * heli_q8_B.Joystick_gain_x *
    ...
    if (heli_q8_B.RateTransitiony > heli_q8_P.DeadZoney_End) {
      rtb_Gain4 = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_End;
    } else if (heli_q8_B.RateTransitiony >= heli_q8_P.DeadZoney_Start) {
      rtb_Gain4 = 0.0;
    } else {
      rtb_Gain4 = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S6>/Gain: y'
     */
    heli_q8_B.Joystick_gain_y = heli_q8_P.Gainy_Gain * rtb_Gain4 *
      heli_q8_P.Joystick_gain_y;

    /* Gain: '<S1>/Gain4' */
    rtb_Gain4 = heli_q8_P.Gain4_Gain * heli_q8_B.Joystick_gain_y;

    /* SignalConversion: '<S1>/TmpSignal ConversionAtTo File2Inport1' */
    rtb_TmpSignalConversionAtToFi_b[0] = rtb_Gain3;
    rtb_TmpSignalConversionAtToFi_b[1] = rtb_Gain4;

    /* ToFile: '<S1>/To File2' */
    if (rtmIsMajorTimeStep(heli_q8_M)) {
      {
        if (!(++heli_q8_DW.ToFile2_IWORK.Decimation % 1) &&
            (heli_q8_DW.ToFile2_IWORK.Count*3)+1 < 100000000 ) {
          ...
          if (fp != (NULL)) {
            ...
            if (fwrite(u, sizeof(real_T), 3, fp) != 3) {
              rtmSetErrorStatus(heli_q8_M,
                                "Error writing to MAT-file Reference.mat");
              return;
            }

            if (((++heli_q8_DW.ToFile2_IWORK.Count)*3)+1 >= 100000000) {
              (void)fprintf(stdout,
                            "*** The ToFile block will stop logging data before\n"
                            "    the simulation has ended, because it has reached\n"
                            "    the maximum number of elements (100000000)\n"
                            "    allowed in MAT-file Reference.mat.\n");
            }
          }
        }
      }
     ...
     *  Sum: '<S5>/Sum'
     */
    heli_q8_B.K_pp = (rtb_Gain3 - heli_q8_B.PitchCounttorad) * heli_q8_P.K_pp;
  }

  /* Sum: '<S5>/Sum1' incorporates:
   *  Gain: '<S5>/K_pd'
   */
  rtb_Frontgain = heli_q8_B.K_pp - heli_q8_P.K_pd * heli_q8_B.PitchTransferFcn;
   ...
   *  Sum: '<S2>/Add'
   */
  u0 = (rtb_Backgain - rtb_Frontgain) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S2>/Subtract'
   */
  u0 = (rtb_Backgain + rtb_Frontgain) * heli_q8_P.Backgain_Gain;
...
void heli_q8_output2(void)             /* Sample time: [0.01s, 0.0s] */
{
  ...
  /* S-Function Block: heli_q8/Controller/Joystick/Game Controller (game_controller_block) */
  {
...
void heli_q8_initialize(void)
{
  ...
  {
    FILE *fp = (NULL);
    char fileName[509] = "enc_2i_3i.mat";
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M, "Error creating .mat file enc_2i_3i.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,7,0,"enc_2i_3i")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file enc_2i_3i.mat");
      return;
    }
  ...
  {
    FILE *fp = (NULL);
    char fileName[509] = "Reference.mat";
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M, "Error creating .mat file Reference.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,3,0,"Reference")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file Reference.mat");
      return;
    }
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File1' */
  {
    ...
    if (fp != (NULL)) {
      char fileName[509] = "enc_2i_3i.mat";
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M, "Error closing MAT-file enc_2i_3i.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M, "Error reopening MAT-file enc_2i_3i.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 7, heli_q8_DW.ToFile1_IWORK.Count,
           "enc_2i_3i")) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for enc_2i_3i to MAT-file enc_2i_3i.mat");
      }
  ...
  /* Terminate for ToFile: '<S1>/To File2' */
  {
    ...
    if (fp != (NULL)) {
      char fileName[509] = "Reference.mat";
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M, "Error closing MAT-file Reference.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M, "Error reopening MAT-file Reference.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 3, heli_q8_DW.ToFile2_IWORK.Count,
           "Reference")) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for Reference to MAT-file Reference.mat");
      }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (141755082U);
  heli_q8_M->Sizes.checksums[1] = (559030699U);
  heli_q8_M->Sizes.checksums[2] = (944652643U);
  heli_q8_M->Sizes.checksums[3] = (3688525468U);
